  ...
  return (
    <div id='features' className='mx-auto mt-48 max-w-7xl px-6 lg:px-8'>
      <div className='mx-auto max-w-2xl text-center'>
        ...
        <div className='flex flex-colmuns-2 gap-2 justify-center mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl '>
          ...
          <div className='mt-2 text-sm sm:text-base text-gray-600 dark:text-white flex items-center'>
            カコクな労働、イラないナ。
            <br />カシコく労働、イイだよネ？
          </div>
        </div>
      </div>
      <div className='mx-auto w-fit mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl'>
