...
export default defineConfig({
  site: 'https://onceagain.alizza-ideal.com',
    ...
    starlight({
      ...
      head: [
        // Add your script tags here. Below is an example for Google analytics, etc.
        {
          tag: 'script',
          attrs: {
            src: 'https://www.googletagmanager.com/gtag/js?id=G-H8HPG087GK',
          },
        },
        {
          tag: 'script',
          ...
          gtag('config', 'G-H8HPG087GK');
          `,
        },
      ],
      editLink: {
        baseUrl: 'https://github.com/tsntsumi',
      },
      components: {
